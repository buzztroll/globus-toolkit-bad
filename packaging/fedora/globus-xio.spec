...
%changelog
* Thu Apr 29 2021 Globus Toolkit <support@globus.org> - 6.2~rc1-1
- Allow prerelease version tags

* Fri Mar 26 2021 Globus Toolkit <support@globus.org> - 6.1-1
- Use prebuilt doxyxgen if available

* Tue Mar 23 2021 Globus Toolkit <support@globus.org> - 6.0-4
- Package update to fix build problem on fedora 33
