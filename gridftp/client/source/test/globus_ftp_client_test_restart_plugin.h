...
typedef enum
{
    ...
    FTP_RESTART_AT_CHGRP,
    FTP_RESTART_AT_CHGRP_RESPONSE, 
    FTP_RESTART_AT_UTIME,
    FTP_RESTART_AT_UTIME_RESPONSE,
    FTP_RESTART_AT_SYMLINK,
    FTP_RESTART_AT_SYMLINK_RESPONSE,
    FTP_RESTART_AT_MLSR,
    FTP_RESTART_AT_MLSR_RESPONSE,   
    FTP_RESTART_AT_CKSM,
